...
const { memoryGuard, heavyOperationGuard } = require('../middleware/memoryGuard');
 ...
 */
router.post('/upload', authenticate, requireAdmin, heavyOperationGuard, upload.single('pdf'), async (req, res, next) => {
